SamacSys ECAD Model
519369/2012225/2.50/17/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOP65P640X120-17N" (originalName "SOP65P640X120-17N")
		(multiLayer
			...
			(pad (padNum 17) (padStyleRef r246_231) (pt 0, 0) (rotation 90))
		)
	...
	(symbolDef "TPS61032PWP" (originalName "TPS61032PWP")
	...
	(compDef "TPS61032PWP" (originalName "TPS61032PWP") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "PGND_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "PGND_3") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VBAT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "LBI") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "SYNC") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "17" (pinName "GND_2") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "16" (pinName "NC") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "15" (pinName "VOUT_3") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "VOUT_2") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "VOUT_1") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "FB") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "GND_1") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "LBO") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "EN") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS61032PWP"))
		...
		(attr "Mouser Part Number" "595-TPS61032PWP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS61032PWP?qs=Gse6rAGbi7%252B07XodIBvuHQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS61032PWP")
		(attr "Description" "5-V Output, 1-A, 96% Efficient Boost Converter w/20uA Iq in TSSOP-16")
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/tps61030.pdf")
		(attr "Height" "1.2 mm")
	)
