...
//2446689/2012225/2.50/3/3/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "Si2323DDS-T1-GE3" (originalName "Si2323DDS-T1-GE3")
	...
	(compDef "Si2323DDS-T1-GE3" (originalName "Si2323DDS-T1-GE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "Si2323DDS-T1-GE3"))
		...
		(attr "Mouser Part Number" "78-SI2323DDS-T1-GE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/SI2323DDS-T1-GE3?qs=vgn07B5hXavjZXK0uPQNiA%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "Si2323DDS-T1-GE3")
		(attr "Description" "VISHAY - SI2323DDS-T1-GE3 - Power MOSFET, P Channel, 20 V, 5.3 A, 0.032 ohm, SOT-23, Surface Mount")
		(attr "<Hyperlink>" "https://altium.componentsearchengine.com/Datasheets/2/SI2323DDS-T1-GE3.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "Si2323DDS-T1-GE3.stp")
