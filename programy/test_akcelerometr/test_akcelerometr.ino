...
void setup() 
{
  ...
  pinMode(26,INPUT);       // Interrupt pin input
...
void loop() 
{
  ...
  if (millis() - loopTimer > 250)
  {
    ...
    Serial.print(z);
    Serial.print(" konw");
    Serial.print(xl.convertToG(6,x)); // The convertToG() function
    Serial.print(" ");
    Serial.print(xl.convertToG(6,y)); // accepts as parameters the
    Serial.print(" ");
    Serial.print(xl.convertToG(6,z)); // raw value and the current
