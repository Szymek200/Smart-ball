...
//969593/2012225/2.50/3/2/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "BSS84" (originalName "BSS84")
	...
	(compDef "BSS84" (originalName "BSS84") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BSS84"))
		...
		(attr "Mouser Part Number" "512-BSS84")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi-Fairchild/BSS84?qs=FOlmdCx%252BAA0e83h5MpSc0g%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "BSS84")
		(attr "Description" "-0.13 A, -50 V RDS(ON) = 10  @ VGS = -5 V; High-Density Cell Design for Low RDS(ON); Voltage-controlled P-channel small signal switch; High Saturation Current.")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/BSS84-D.PDF")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "BSS84.stp")
