...
//978758/2012225/2.50/3/2/MOSFET N-Channel
...
(library Library_1
	...
	(compDef "BSS138" (originalName "BSS138") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi-Fairchild/BSS138?qs=HK%252BeIG1iaahCeqBvjB4arg%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "BSS138")
		(attr "Description" "Compact industry standard SOT-23 surface mount package.; 0.22 A, 50 V. RDS(ON) = 3.5  @ VGS = 10 V. RDS(ON) = 6.0  @ VGS = 4.5 V; Rugged and Reliable.; High density cell design for extremely low RDS(ON).")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/BSS138-D.PDF")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "BSS138.stp")
