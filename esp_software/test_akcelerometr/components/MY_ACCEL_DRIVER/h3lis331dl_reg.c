                                        ...
                                        int16_t *val)
{
  ...
  // ZMIANA: Dodajemy 0x80 (Autoincrement bit) do adresu startowego (0x28U)
  // W H3LIS331DL to musi być zrobione bezpośrednio przed odczytem.
  uint8_t reg_addr = H3LIS331DL_OUT_X_L | 0x80;

  // ZMIANA: Zmieniamy oryginalne wywołanie na użycie zmodyfikowanego adresu
  ret = h3lis331dl_read_reg(ctx, reg_addr, buff, 6); // Używamy reg_addr zamiast H3LIS331DL_OUT_X_L
